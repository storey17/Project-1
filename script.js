...
var queryURL =
  "https://api.nytimes.com/svc/search/v2/articlesearch.json?q=election&fq=news_desk:('Politics')('Washington')&api-key=PRDkjbCFU5eSMenXggU1owKkJyQjyAnU";
...
$.ajax({
  ...
  $nytImage.attr(
    "src",
    "https://nytimes.com/" + response.response.docs[0].multimedia[2].url
  );
...
var guardianSettings = {
  ...
  // crossDomain: true,
  url:
    "https://content.guardianapis.com/search?q=us-news%2Fus-elections-2020&api-key=a42a50d2-e130-42f2-98e1-e6e71b872da7&show-fields=thumbnail",
  method: "GET"
  // data: {}
};
